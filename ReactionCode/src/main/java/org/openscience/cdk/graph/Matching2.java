...
public final class Matching2 {
    ...
    public boolean perfect(int[][] graph, BitSet subset) {
        ...
        EdmondsMaximumMatching2.maxamise(this, graph, subset);
     ...
     */
    public static Matching2 withCapacity(final int capacity) {
        return new Matching2(capacity);
    }
     ...
     * @return matching
     */
    public static Matching2 empty(Graph g) {
        return new Matching2(g.order());
    }
    
    /**
     * Allocate a matching with enough capacity for the given graph.
     *
     * @param i size of the molecule
     * @return matching
     */
    public static Matching2 empty(int i) {
        return new Matching2(i);
    }
