 ...
 * @cdk.module standard
 */
final class EdmondsMaximumMatching2 {

    /** The graph we are matching on. */
    private final int[][]             graph;

    /** The current matching. */
    private final Matching2            matching;
     ...
     */
    private EdmondsMaximumMatching2(int[][] graph, Matching2 matching, BitSet subset) {
     ...
     * @return the matching
     */
    static Matching2 maxamise(Matching2 matching, int[][] graph, BitSet subset) {
        new EdmondsMaximumMatching2(graph, matching, subset);
        return matching;
    }
