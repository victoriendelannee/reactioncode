...
public final class CDKToBeam2 {
    ...
    CDKToBeam2(int flavour) {
        this.flavour = flavour;
    }

    public Graph toBeamGraph(IAtomContainer ac) throws CDKException {
     ...
     */
    public static Graph toBeamGraph(IAtomContainer ac, int flavour) throws CDKException {
