...
public class QueryAtom extends QueryChemObject implements IQueryAtom {
    ...
    public QueryAtom(int elem, IChemObjectBuilder builder) {
        this(builder);
        this.symbol = Elements.ofNumber(elem).symbol();
        this.atomicNumber = PeriodicTable.getAtomicNumber(symbol);
    }
    ...
    */
     ...
     * Sets the element symbol of this element.
     *
     * @param elem The element elem to be assigned to this atom
     *
     * @see    #getSymbol
     */
    public void setSymbol(int elem) {
        this.symbol = Elements.ofNumber(elem).symbol();
        notifyChanged();
    }
